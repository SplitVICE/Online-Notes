...
/* if ($public_notes_result->num_rows > 0) {
    while ($row = $public_notes_result->fetch_assoc()) {
        echo "<div class='note_container'>";
        echo "<div class='note_title'>".$row["title"] . "</div>";
        echo "<br>";
        echo "<div class='note_description'>" . $row["description"]. "</div>";
        echo "<br>";
        echo "<div class='note_delete_button'><a href='#' onclick='deletePublicNote(" . $row["ID"] . ")'>Delete this note</a></div>";
        echo "</div>";
        echo "<br>";
    }
} else {
